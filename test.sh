...
su -c "unshare --user --map-root-user --fork sh -c 'echo \$\$ > /tmp/sleeper.pid ; cat /proc/self/uid_map; exec sleep infinity'" -- $(id -un 1000) &
...
PID_TO_JOIN=$PID
strace -f -s 64 -e fsconfig,fsmount,move_mount,mount \
./nfs-mount-in-userns /proc/$PID_TO_JOIN/ns/net /proc/$PID_TO_JOIN/ns/net /proc/$PID_TO_JOIN/ns/mnt
...
echo "Files on the NFS mountpoint:"
rm -f /mnt/nfs/new-file
touch /mnt/nfs/new-file
touch /mnt/nfs/dir-1000/new-file
ls -lan /mnt/nfs
